...
function contact(){
    ...
    <div class="shadow-md w-full max-w-2xl px-6 py-4 mx-auto bg-white dark:bg-gray-800 pb-10">
        ...
        <div class="grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-2 pb-5">
            ...
            <a href="mailto:hello@blazed.space" class="flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500">
                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
